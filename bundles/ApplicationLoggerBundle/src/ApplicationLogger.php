...
class ApplicationLogger implements LoggerInterface
{
    ...
    public function logException(string $message, Throwable $exceptionObject, ?string $priority = 'alert', \Pimcore\Model\DataObject\AbstractObject|null $relatedObject = null, ?string $component = null): void
    {
        if (is_null($priority)) {
            $priority = 'alert';
        }
    ...
    public static function logExceptionObject(
        ...
        string $message,
        Throwable $exception,
        int|string|Level $level = Level::Alert, \Pimcore\Model\DataObject\AbstractObject|null $relatedObject = null,
        array $context = []
    ): void {
