...
abstract class FrontendController extends Controller
{
     ...
     * @throws Exception
     */
    public function getDocumentEditable(string $type, string $inputName, array $options = [], Document\PageSnippet|null $document = null): Document\Editable\EditableInterface
    {
        if (null === $document) {
