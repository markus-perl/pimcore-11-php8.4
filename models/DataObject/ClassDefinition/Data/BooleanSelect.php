    ...
    NormalizerInterface
{
     ...
     *
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?bool
    {
        if (is_numeric($data)) {
            $data = (int) $data;
        }
     ...
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?int
    {
     ...
     *
     */
    public function getDataForResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?int
    {
        if (is_numeric($data)) {
            $data = (bool) $data;
        }
     ...
     *
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?bool
    {
        if ((int)$data === 1) {
            return true;
        } elseif ((int)$data === -1) {
