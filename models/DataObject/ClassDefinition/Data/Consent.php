...
class Consent extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface
{
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\Consent
    {
     ...
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): bool
    {
        if ($data instanceof DataObject\Data\Consent) {
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\Consent
    {
        if ($data === 'false') {
            $data = false;
        }
     ...
     *  - "data" => the data
     */
    public function getDiffDataFromEditmode(array $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\Consent
    {
        $data = $data[0]['data'];
