    ...
    NormalizerInterface
{
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?CarbonPeriod
    {
        $startDateKey = $this->getName() . '__start_date';
        $endDateKey = $this->getName() . '__end_date';
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?CarbonPeriod
    {
    ...
    public function getDataFromGridEditor(array $data, DataObject\Concrete|null $object = null, array $params = []): ?CarbonPeriod
    {
        if ($data['start_date']) {
    ...
    public function getDataForGrid(?CarbonPeriod $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
