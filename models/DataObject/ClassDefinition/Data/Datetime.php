...
class Datetime extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface
{
     ...
     *
     */
    public function getDataForResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): int|string|null
    {
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Carbon
    {
        if ($data) {
            if ($this->getColumnType() == 'datetime') {
                $data = strtotime($data);
     ...
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): int|string|null
    {
     ...
     *
     */
    public function getDataForEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?int
    {
        if ($data) {
     ...
     *
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Carbon
    {
        if (is_numeric($data)) {
     ...
     *
     */
    public function getDiffDataFromEditmode(array $data, DataObject\Concrete|null $object = null, array $params = []): ?Carbon
    {
        $thedata = $data[0]['data'];
        if ($thedata) {
