...
class EncryptedField extends Data implements ResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface, LayoutDefinitionEnrichmentInterface
{
     ...
     */
    public function getDataForResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): mixed
    {
        if ($data) {
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\EncryptedField
    {
        /** @var ResourcePersistenceAwareInterface|null $fd */
        $fd = $this->getDelegateDatatypeDefinition();
        if ($fd) {
     ...
     */
    public function getDataForEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): mixed
    {
        $fd = $this->getDelegateDatatypeDefinition();
        if ($fd) {
            $data = $data instanceof Model\DataObject\Data\EncryptedField ? $data->getPlain() : $data;
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\EncryptedField
    {
        $fd = $this->getDelegateDatatypeDefinition();
        if ($fd) {
    ...
    public function getDataFromGridEditor(mixed $data, Model\DataObject\Concrete|null $object = null, array $params = []): mixed
    {
        $fd = $this->getDelegateDatatypeDefinition();
     ...
     */
    public function getDataForGrid(mixed $data, Model\DataObject\Concrete|null $object = null, array $params = []): mixed
    {
        $fd = $this->getDelegateDatatypeDefinition();
        if ($fd) {
