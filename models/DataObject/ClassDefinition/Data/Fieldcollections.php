...
class Fieldcollections extends Data implements CustomResourcePersistingInterface, LazyLoadingSupportInterface, TypeDeclarationSupportInterface, NormalizerInterface, DataContainerAwareInterface, IdRewriterInterface, PreGetDataInterface, PreSetDataInterface
{
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Fieldcollection
    {
        $values = [];
        $count = 0;
    ...
    public function getDataForGrid(?DataObject\Fieldcollection $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
        if (null === $data) {
            return null;
        }
