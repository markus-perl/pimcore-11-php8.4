...
class Hotspotimage extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, NormalizerInterface, IdRewriterInterface
{
     ...
     *
     */
    public function getDataForResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): array
    {
     ...
     *
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?DataObject\Data\Hotspotimage
    {
     ...
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): array
    {
     ...
     *
     */
    public function getDataForEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
        if ($data instanceof DataObject\Data\Hotspotimage) {
            $imageId = null;
            if ($data->getImage()) {
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?DataObject\Data\Hotspotimage
    {
        $rewritePath = function ($data) {
            if (!is_array($data)) {
                return [];
    ...
    public function getDataFromGridEditor(array $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\Hotspotimage
    {
     ...
     *
     */
    public function getVersionPreview(mixed $data, DataObject\Concrete|null $object = null, array $params = []): string
    {
    ...
    public function getDataForGrid(?DataObject\Data\Hotspotimage $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
