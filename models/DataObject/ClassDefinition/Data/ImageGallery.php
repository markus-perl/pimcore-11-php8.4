...
class ImageGallery extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface, IdRewriterInterface
{
     ...
     *
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\ImageGallery
    {
        if (!is_array($data)) {
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\ImageGallery
    {
        $resultItems = [];
    ...
    public function getDataFromGridEditor(?array $data, DataObject\Concrete|null $object = null, array $params = []): DataObject\Data\ImageGallery
    {
    ...
    public function getDataForGrid(?DataObject\Data\ImageGallery $data, DataObject\Concrete|null $object = null, array $params = []): array
    {
