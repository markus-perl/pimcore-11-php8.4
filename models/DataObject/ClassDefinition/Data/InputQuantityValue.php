...
class InputQuantityValue extends AbstractQuantityValue
{
    ...
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?InputQuantityValueDataObject
    {
    ...
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?InputQuantityValueDataObject
    {
        if (is_array($data)) {
