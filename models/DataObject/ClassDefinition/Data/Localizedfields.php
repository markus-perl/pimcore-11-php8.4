...
class Localizedfields extends Data implements CustomResourcePersistingInterface, TypeDeclarationSupportInterface, NormalizerInterface, DataContainerAwareInterface, IdRewriterInterface, PreGetDataInterface, VarExporterInterface, FieldDefinitionEnrichmentModelInterface
{
    ...
    public function getDataForEditmode(mixed $localizedField, DataObject\Concrete|null $object = null, array $params = []): array
    {
        $fieldData = [];
        $metaData = [];
    ...
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): Localizedfield
    {
    ...
    public function getDiffDataFromEditmode(array $data, DataObject\Concrete|null $object = null, array $params = []): Localizedfield
    {
