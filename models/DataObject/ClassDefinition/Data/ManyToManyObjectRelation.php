...
class ManyToManyObjectRelation extends AbstractRelations implements QueryResourcePersistenceAwareInterface, OptimizedAdminLoadingInterface, VarExporterInterface, NormalizerInterface, PreGetDataInterface, PreSetDataInterface, LayoutDefinitionEnrichmentInterface
{
     ...
     *
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?string
    {
     ...
     *
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
    ...
    public function getDataForGrid(?array $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
     ...
     * @internal
     */
    protected function processDiffDataForEditMode(mixed $originalData, mixed $data, DataObject\Concrete|null $object = null, array $params = []): array
    {
        if ($data) {
            $data = $data[0];
    ...
    public function getDiffDataForEditMode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
        $originalData = $data;
     ...
     *
     */
    public function getDiffDataFromEditmode(array $data, DataObject\Concrete|null $object = null, array $params = []): ?array
    {
        if ($data) {
