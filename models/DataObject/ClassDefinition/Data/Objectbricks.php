...
class Objectbricks extends Data implements CustomResourcePersistingInterface, TypeDeclarationSupportInterface, NormalizerInterface, DataContainerAwareInterface, IdRewriterInterface, PreSetDataInterface
{
     ...
     *
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): Objectbrick
    {
     ...
     *
     */
    public function getDiffDataFromEditmode(array $data, DataObject\Concrete|null $object = null, array $params = []): mixed
    {
