...
class QuantityValue extends AbstractQuantityValue
{
    ...
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\QuantityValue
    {
    ...
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\QuantityValue
    {
