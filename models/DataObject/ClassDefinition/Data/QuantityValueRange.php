...
class QuantityValueRange extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface
{
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?DataObject\Data\QuantityValueRange
    {
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?DataObject\Data\QuantityValueRange
    {
    ...
    public function getDataFromGridEditor(array $data, DataObject\Concrete|null $object = null, array $params = []): ?DataObject\Data\QuantityValueRange
    {
    ...
    public function getDataForGrid(
        ?DataObject\Data\QuantityValueRange $data, DataObject\Concrete|null $object = null,
        array $params = []
    ): ?array {
