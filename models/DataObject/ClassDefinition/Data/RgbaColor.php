    ...
    AfterDecryptionUnmarshallerInterface
{
     ...
     *
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\RgbaColor
    {
     ...
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?Model\DataObject\Data\RgbaColor
    {
        if ($data) {
            $data = trim($data, '# ');
