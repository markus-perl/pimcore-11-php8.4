...
class Slider extends Data implements ResourcePersistenceAwareInterface, QueryResourcePersistenceAwareInterface, TypeDeclarationSupportInterface, EqualComparisonInterface, VarExporterInterface, NormalizerInterface
{
     ...
     */
    public function getDataForResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?float
    {
        if ($data != null) {
            $data = (float) $data;
        }
     ...
     */
    public function getDataFromResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?float
    {
        if ($data != null) {
            $data = (float) $data;
        }
     ...
     */
    public function getDataForQueryResource(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?float
    {
        return $data;
    }
     ...
     *
     */
    public function getDataForEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?float
    {
     ...
     *
     */
    public function getDataFromEditmode(mixed $data, DataObject\Concrete|null $object = null, array $params = []): ?float
    {
