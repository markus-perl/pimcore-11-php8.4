...
class Service extends Model\Element\Service
{
    ...
    public function __construct( Model\User|null $user = null)
    {
        $this->_user = $user;
    }
     ...
     */
    private static function getValueForObject(Concrete $object, string $key, ?string $brickType = null, ?string $brickKey = null, ClassDefinition\Data|null $fieldDefinition = null, array $context = [], ?array $brickDescriptor = null, ?string $requestedLanguage = null): stdClass
    {
        $getter = 'get' . ucfirst($key);
        $value = null;
