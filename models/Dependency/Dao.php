...
class Dao extends Model\Dao\AbstractDao
{
    ...
    public function getFilterRequiresByPath( ?int $offset = null, ?int $limit = null, ?string $value = null, ?string $orderBy = null, ?string $orderDirection = null): array
    {
    ...
    public function getFilterRequiredByPath( ?int $offset = null, ?int $limit = null, ?string $value = null, ?string $orderBy = null, ?string $orderDirection = null
    ): array {
