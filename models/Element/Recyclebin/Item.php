...
class Item extends Model\AbstractModel
{
    ...
    public static function create(Element\ElementInterface $element, Model\User|null $user = null): void
    {
        $item = new self();
     ...
     * @throws Exception
     */
    public function restore( Model\User|null $user = null): void
    {
        $dummy = null;
    ...
    public function save( Model\User|null $user = null): void
    {
